...
*/
        ...
        /**
         * 사운드 리소스는 UI 스레드를 차단하지 않고, 비동기로로드
         */
...
/*
        ...
        recordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecording) {
                    ...
                    // 기록의 끝에 저장공간 RecordInfo，최종 로고
                    // 어떤 키가없는 경우 식별자가 저장되어 있지 않습니다
        ...
        final Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 1) {
                    ...
                    isPlaying = false;
                    playBtn.setText("재생");
                    Toast.makeText(MainActivity.this, "재생 완료", Toast.LENGTH_SHORT).show();
                } else if (msg.what == 3) {         // 피치 이동
                    ...
                    Toast.makeText(MainActivity.this, "톤 스위치" + tuneRadio.getText(), Toast.LENGTH_SHORT).show();
                }
            }
        };
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecording) {
                    Toast.makeText(MainActivity.this, "기록되니 걱정하지 마세요!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (timeTunesMap.isEmpty()) {
                    Toast.makeText(MainActivity.this, "당신은 녹화를 하지않는 것，업로드 후 기록~", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//            Toast.makeText(MainActivity.this, timeTunesMap.toString(), Toast.LENGTH_LONG).show();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    tuneRadio.performClick();
                    Toast.makeText(MainActivity.this, "자동으로 톤 전환 " + tuneRadio.getText() + "재생", Toast.LENGTH_SHORT).show();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (lastBackTimestamp == 0 || nowTimeStamp - lastBackTimestamp > 2000) {
                ...
                Toast.makeText(MainActivity.this, "다시 눌러 종료합니다", Toast.LENGTH_SHORT).show();
                return true;
            } else {
